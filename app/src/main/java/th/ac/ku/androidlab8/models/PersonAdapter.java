...
public class PersonAdapter extends ArrayAdapter<Person> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView nicknameTextView = (TextView) convertView.findViewById(R.id.nickNameField);
        TextView firstnameTextView = (TextView) convertView.findViewById(R.id.firstField);
        TextView lastnameTextView = (TextView) convertView.findViewById(R.id.lastField);
